...
void ST7735_DrawCharLandscape(int16_t x, int16_t y, char c, int16_t textColor, int16_t bgColor, uint8_t size);

void ST7735_DrawBitmapLandscape(int16_t x, int16_t y, const uint16_t *image, int16_t w, int16_t h);

void ST7735_DrawBitmapT(int16_t x, int16_t y, const uint16_t *image, int16_t w, int16_t h);

#include "PokeLib.h"

void ST7735_PrintMap(Map_t *Map, const uint16_t *trainer, int32_t row, int32_t col, int upDown, int leftRight, int adjust);
